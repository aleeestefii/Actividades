...
listen()
onkey(undo, 'u')
onkey(lambda: color('pink'), 'P') #Se agrego el color Rosa al simplemente colocar el nombre del color
...
onkey(lambda: store('shape', draw_circle), 'c') #Cambie el nombre de circle ya que tenia conflictos con la funcion circle y arrojaba un error
